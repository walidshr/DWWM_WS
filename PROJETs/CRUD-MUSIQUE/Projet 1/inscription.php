...
@media(max-width: 720px) {
    ...
    <div class="collapse navbar-right navbar-collapse" id="myNavbar">
        ...
        <p><input class="btn1" type="submit" name="btn1" value="Home" onclick="return action='index.php'"/> <input class="btn1" type="submit" name="btn1" value="Connexion" onclick="return action='connexion.php'"/></p>
        </form>
        </ul>
    </div>
</div>
...
if (!empty($_POST['nom_artiste']) && !empty($_POST['prenom_artiste']) && !empty($_POST['password'])) {
    ...
    $req = $pdo->prepare("INSERT INTO Artistes(nom_artiste,prenom_artiste,password) VALUES (:nom_artiste, :prenom_artiste, :password)");
